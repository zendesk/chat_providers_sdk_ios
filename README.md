...
# Zendesk Chat Providers SDK for iOS
...
acknowledge that such terms govern Your use of and access to the Chat Providers SDK.

If You make any Contributions (defined below) to the Zendesk Chat Providers SDK, 
